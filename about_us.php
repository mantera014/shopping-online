...
?>
  ...
  <tr>
    <td><text class="logo"><i><strong> About Us</strong></i></text></td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td width="192"><text class="logo_nav">
      <div align="center"><em><a href="size_chart.php" style="text-decoration: none">Sizing Chart</a></em></div>
    </text></td>
...
<table width="96%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="41%" valign="top"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="3" class="page"><p>TEXT.............................<br>
  <br>
  <br>
          ..........</p>
          <p>&nbsp;</p></td>
      ...
      <tr>
        ...
        <td align="center" class="page"><a href="http://instagram.com/fourtyfiveskateshop" target="_new"><img src="images/Instagram_Icon_Large.png" width="50" height="50"></a>
    ...
    <td width="4%">&nbsp;</td>
    <td width="55%"><div align="center"><img src="images/about_us_image.jpg" width="479" height="479"></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
