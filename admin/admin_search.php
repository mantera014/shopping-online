...
<input type="submit" name="submit" value=" Search ">&nbsp;
  ...
  <tr>
    <td valign="top" height="329" colspan="2"><table border="0" cellspacing="0" cellpadding="0">
      <tr><?php $num_items=mysql_num_rows($search_result);?>
        <td width="738" colspan="5" class="text_menu"><strong>/ / ITEMS RELATED TO SEARCH :( <text class="highlight"><?php echo $num_items; ?></text> )</strong>
        </td>
        </tr>
      <tr>
        <td width="300">
