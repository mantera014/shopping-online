...
print <<<HERE
<p class="text_menu"><b> The data has been Deleted : <text class="highlight">$id</text> / / <text class="highlight">$item_name</text> / / <text class="highlight">$item_price</text> </b></p>
HERE;
