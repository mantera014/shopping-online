...
?>
  ...
  <tr>
    <td><text class="logo"><i><strong> Search Result</strong></i></text></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td class="logo_font"><br><i>Displaying Search Result: </i>(<b> <text class="highlight"><?php $item_srh_total=mysql_num_rows($search_result); echo $item_srh_total; ?></text></b> )</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
...
<td>
 <?php  
$i=0;
$items=mysql_num_rows($search_result);
while(($data=mysql_fetch_array($search_result))&&($i<$items)){
$id=$data["id"];
$item_name=$data["name"];
...
<p align="center">
<p align="left">[ CODE: <text class="highlight">MO$id</text> ]</p>
...
<td style="background-color:transparent;border:0px #C0C0C0 solid;text-align:left;vertical-align:top;height:43px;" ><div align="right"><a href="cilent_search.php">Close [X]</a></div></td>
</tr>
<tr>
