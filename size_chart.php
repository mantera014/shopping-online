...
?>
  ...
  <tr>
    <td><text class="logo"><i><strong> Sizing Chart</strong></i></text></td>
    <td>&nbsp;</td>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="41%" valign="top"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="3" valign="top" class="page"><p>TEXT......................</p>
          <p>&nbsp;</p></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td align="center" class="page"><strong><a href="http://instagram.com/fourtyfiveskateshop" target="_blank" style="text-decoration:none;" class="white_text"><img src="images/Instagram_Icon_Large.png" width="50" height="50"></a>
    ...
    <td width="4%">&nbsp;</td>
    <td width="55%"><div align="center"><img src="images/bg-sign-up.gif" width="456" height="247" /></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
