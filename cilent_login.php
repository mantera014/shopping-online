...
<tr>
  <td colspan="2"><table width="548" align="center"><tr><td width="540">
  ...
  <input type="submit" value="Login"></center></td>
    ...
    <p align="center" class="login" style="color:#000000"><b>Please Login with Username / Password.<br>
      Please 
      Login or Sign up <a href="sign_up.php">HERE</a> || <a href="index.php">HOME</a></b></p></td></tr></table>
    </td>
</tr>
<tr>
